...
//        lblfecha.setText(hoy + "");
 ...
 private void vistaprevia() {
        ...
        try {
            ...
            String ruta = System.getProperty("user.dir") + "/src/uni/reportes/FacturaVenta.jasper";
        ...
        } catch (SQLException | ClassNotFoundException | InstantiationException | IllegalAccessException | NumberFormatException | JRException e) {
